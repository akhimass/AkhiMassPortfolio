...
const CapabilityCard = ({
  ...
  return (
    ...
    >
      <div
        className="group relative rounded-xl border border-border/50 bg-card overflow-hidden cursor-pointer transition-all duration-300 hover:border-opacity-50"
        style={{
      ...
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        >
          ...
          <p className="text-muted-foreground text-sm max-w-lg">
            Six layers of technical capability — applied together to ship
            intelligent systems, not just individual features.
          </p>
        </motion.div>
