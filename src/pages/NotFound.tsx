  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#09090b] px-6 text-center">
      <motion.div
        ...
        className="max-w-md"
      >
        <p className="text-xs font-semibold uppercase tracking-widest text-violet-400 mb-3">404</p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <Button asChild className="rounded-full bg-gradient-to-r from-[#7c3aed] to-[#6366f1] border-0">
            <Link to="/">
