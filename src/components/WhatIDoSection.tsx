  ...
  return (
    <section id="what-i-do" className="relative border-t border-white/5 py-24 lg:py-28">
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-10">
        ...
        >
          <p className="mb-2 text-xs font-semibold uppercase tracking-widest text-violet-400">What I do</p>
        ...
        <div id="capabilities" className="scroll-mt-28 border-t border-white/10 pt-16 mt-16 lg:mt-20 lg:pt-20">
          <motion.div
            ...
            className="mb-10"
          >
            <p className="mb-2 text-xs font-semibold uppercase tracking-widest text-violet-400">Technical skills</p>
