...
const JourneyStep = ({
  ...
  return (
    <motion.div ref={ref} style={{ opacity, x }} className="flex gap-8 items-start group">
      <div className="flex flex-col items-center flex-shrink-0 w-16">
        ...
        {index < JOURNEY.length - 1 && (
          <div
            className="w-px flex-1 mt-3 min-h-[80px]"
      ...
      <div className="pb-14">
        <h3 className="text-lg font-bold tracking-tight mb-2" style={{ color: step.accent }}>
          {step.label}
        </h3>
        <p className="text-sm text-muted-foreground leading-relaxed mb-4 max-w-lg">{step.description}</p>
  ...
  return (
    <section id="story" className="py-28 relative">
      <div
        ...
        style={{
          background: "radial-gradient(ellipse at left center, rgba(99,102,241,0.07) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="container mx-auto px-6 max-w-4xl">
        <motion.div
          ...
          className="mb-16"
        >
          <p className="text-xs text-violet-400 font-semibold uppercase tracking-widest mb-2">The Journey</p>
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight mb-3 font-display">From code to intelligent systems.</h2>
          <p className="text-muted-foreground text-sm max-w-lg">
            A progressive evolution — each layer building on the last, from software fundamentals to full-stack AI platform
            engineering.
          </p>
        </motion.div>
