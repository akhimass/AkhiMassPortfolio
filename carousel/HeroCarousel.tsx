...
const SCENES: Scene[] = [
  {
    ...
    headline: "Engineered through data, AI & software",
    sub: "Tracking and models for elite performance — NBA shot quality, EPM, eFG%, TS%, RAPTOR-style signals, and beyond.",
    accent: "#10b981",
    accentGlow: "rgba(16,185,129,0.15)",
    draw: drawSportsScene,
    stats: [
      { label: "NBA shot xSQ", value: "+4.8", x: "5%", y: "9%", delay: 0.1 },
      { label: "EPM", value: "+6.2", x: "56%", y: "10%", delay: 0.2 },
      { label: "eFG%", value: "58.4%", x: "8%", y: "64%", delay: 0.3 },
      { label: "TS% / RAPTOR", value: "61% · +5.4", x: "50%", y: "66%", delay: 0.4 },
    ],
  },
  {
    id: "health",
    ...
    stats: [
      { label: "Variants / strain", value: "2.4k", x: "5%", y: "9%", delay: 0.1 },
      { label: "Trial power (1−β)", value: "0.92", x: "52%", y: "10%", delay: 0.2 },
      { label: "ABX susceptibility", value: "94%", x: "8%", y: "64%", delay: 0.3 },
      { label: "MIC fold vs ref", value: "−2.1×", x: "48%", y: "66%", delay: 0.4 },
    ],
  },
  {
    id: "coaching",
